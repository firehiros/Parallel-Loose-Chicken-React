...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Parallel Loose Chicken</title>
        <meta property="og:title" content="Parallel Loose Chicken" />
      </Helmet>
      ...
      <div className="home-banner">
        ...
        <h1 className="home-text02">Learn to keep it simple</h1>
        ...
        <div className="home-links-container">
          ...
          <div className="home-container09">
            <div className="home-container10">
              <span className="home-text26">Support</span>
              <span className="home-text27">Terms of service</span>
              <span className="home-text28">Privacy Policy</span>
              <span className="home-text29">Legal</span>
              <span>Help center</span>
            </div>
            <div className="home-container11">
              <span className="home-text31">Resources</span>
              <span className="home-text32">Blog</span>
              <span className="home-text33">Pricing</span>
              <span className="home-text34">Service</span>
              <span>Product</span>
            </div>
          </div>
        </div>
